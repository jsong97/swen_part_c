...
public class MoveDecision {
	...
	public void MoveDecision(boolean isFollowingWall, WorldSpatial.Direction previousState, int nextMove,
			HashMap<Coordinate, MapTile> map, HashMap<Coordinate, Boolean> visitedMap) {
